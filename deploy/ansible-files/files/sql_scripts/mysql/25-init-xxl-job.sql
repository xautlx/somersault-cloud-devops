...
INSERT INTO `xxl_job_group` (`id`, `app_name`, `title`, `address_type`, `address_list`) VALUES (2, 'system-server', 'system-serve', 0, '');
INSERT INTO `xxl_job_group` (`id`, `app_name`, `title`, `address_type`, `address_list`) VALUES (3, 'infra-server', 'infra-server', 0, '');
INSERT INTO `xxl_job_group` (`id`, `app_name`, `title`, `address_type`, `address_list`) VALUES (4, 'bpm-server', 'bpm-server', 0, '');
...
VALUES (1, 'admin', '291863fbf5643d90992ae61c8c167fbc', 1, NULL);
